...
function findClosestJavaVersion( javaVersion ) {
	
	//const requiredJavaVersion = savedVersions.java.minor + "." + savedVersions.java.minor;
	return '';
}
...
function prepare( options = {} ) {
	...
	const javaDir = findClosestJavaVersion( savedVersions.java );
	if ( !javaDir ) {

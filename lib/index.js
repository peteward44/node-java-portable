...
function verify( options, currentVersions ) {
	...
	return Promise.resolve( rejectionReasons );
}
...
function start( options = {} ) {
	...
	.then( currentVersions => {
		...
		.then( () => {
			...
			const libPath = getJavaLibPath( currentVersions.java.dir );
			return new Promise( ( resolve, reject ) => {
